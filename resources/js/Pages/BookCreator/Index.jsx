        ...
        },
        {
            ...
            cell: (row) => (
                <div className="flex space-x-2">
                    <a
                        href={route('book-creators.show', row.id)}
                    ...
                    <a
                        href={route('book-creators.edit', row.id)}
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                        ...
                        >
                            <PrimaryAnchor href={route('book-creators.create')}>
                                Create New Creator
                            </PrimaryAnchor>
                        </div>

                        <div className="p-6 text-gray-900">
                            <Table data={creators} columns={columns} />
                        </div>
                    </div>
                </div>
            </div>
